...
## Korean
# kor
kor_symbols = [_pad, _eos] + _kor_characters + _punc + _SILENCES + [_sos] + list(_jamo_trashes)

# Chinese
# cht
cht_symbols = [_pad, _eos] + _cht_characters + _punc + [_sos]

# Japanese
# jap, jap_romaji
jap_romaji_symbols = [_pad, _eos] + _jap_romaji_characters + _punc + [_sos]
# jap_kana
jap_kana_symbols = [_pad, _eos] + _jap_kana_characters + _punc + [_sos]
